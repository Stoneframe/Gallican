...
public class DBTablePrinter
{
	 ...
	 */
	public static
		void printTable(Connection conn, String tableName, int maxRows, int maxStringColWidth)
	{
		if (conn == null)
		{
			System.err
				.println("DBTablePrinter Error: No connection to database (Connection is null)!");
			return;
		}
		if (tableName == null)
		{
				...
				for (int i = 0; i < columnCount; i++)
				{
					...
					switch (category)
					{
						case CATEGORY_DOUBLE:
							...
							// For real numbers, format the string value to have
							// 3 digits
							// after the point. THIS IS TOTALLY ARBITRARY and
							// can be
